...
- Sellers miss optimization opportunities because the portal doesn't proactively surface them
...
- Displayed in the wizard (Step 5) and optionally on dashboards
...
**UI Requirements:**
- Mockup: [Prototype — ASIN Dashboard](http://localhost:8765/Advertising%20Portal%20UI%20Design.html) (navigate to ADS Performance)
...
- Detailed campaign-level analytics (covered by Story 8: Logs & Analytics)
- Keyword-level bid optimization (covered by Story 5: Keyword Settings)
- Full pacing management controls (covered by Story 8)
